...
public class SearchBaseAdapter extends RecyclerView.Adapter<SearchBaseAdapter.ViewHolder> {
    ...
    public SearchBaseAdapter(Context context, List<Redwine> redwineList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHolder viewHolder = new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.search_list_item, parent, false));
        return viewHolder;
    }
