 ...
 */
public class RedwineTypeAdapter extends RecyclerView.Adapter<RedwineTypeAdapter.ViewHolder> {
    Intent intent;
    int redwine_id;
    ...
    public RedwineTypeAdapter(Context context, List<Redwine> redwineList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHolder viewHolder = new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.redwine_type_list_item, parent, false));
        return viewHolder;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.redwine_type.setText(redwineList.get(position).getRedwine_type().getType_name());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            redwine_type = (TextView) itemView.findViewById(R.id.redwine_type);
        }
    }
}
